...
const DOWNLOAD_CONVERSION_LABEL = process.env.NEXT_PUBLIC_GOOGLE_ADS_DOWNLOAD_CONVERSION_LABEL || ''
const DOWNLOAD_CONVERSION_SEND_TO =
  process.env.NEXT_PUBLIC_GOOGLE_ADS_DOWNLOAD_CONVERSION_SEND_TO ||
  (GOOGLE_ADS_ID && DOWNLOAD_CONVERSION_LABEL ? `${GOOGLE_ADS_ID}/${DOWNLOAD_CONVERSION_LABEL}` : '')
